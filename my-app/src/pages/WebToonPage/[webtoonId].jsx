...
const WebToonPage = () => {
  ...
  const getWebtoonImage = (webtoon, episodeNumber) => {
    const webtoonImages = {
      "똑 닮은 딸": {
        1: Array.from({ length: 102 }, (_, i) => `/WebtoonImg/web1/web1_1/web1_1_${i + 1}.png`),
        2: Array.from({ length: 5 }, (_, i) => `/WebtoonImg/web1/web1_2/web1_2_${i + 1}.png`),
        3: Array.from({ length: 5 }, (_, i) => `/WebtoonImg/web1/web1_3/web1_3_${i + 1}.png`),
      },
      "마루는 강쥐": {
